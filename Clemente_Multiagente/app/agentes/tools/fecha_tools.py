...
Es la forma trazable de que el modelo resuelva "manana" o "este viernes": la
respuesta sale del reloj de America/Lima y queda registrada por `con_traza`,
asi que la evaluacion puede comprobar que el turno consulto la fecha en vez
de calcularla de memoria.
"""
...
def get_current_datetime(runtime: ToolRuntime) -> str:
    ...
    (zona America/Lima) y la fecha de cada uno de los proximos siete dias.
